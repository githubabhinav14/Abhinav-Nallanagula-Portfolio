        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <SectionReveal delay={100}>
            <div className="space-y-6">
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5"
              >
                Download CV
              </a>
            </div>
